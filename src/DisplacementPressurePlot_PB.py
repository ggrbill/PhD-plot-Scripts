...
grid = "91"
t = open("Terzaghi_Solution_91_Elements//topDisplacement_"+ grid +".csv")
b = open("Terzaghi_Solution_91_Elements//BottomPressure_"+ grid +".csv")
s = open("Terzaghi_Solution_91_Elements//BottomSigmaYY_"+ grid +".csv")
...
plt.plot( anlCurrentTime, anlDisplacement, '-', linewidth = 0.9, color = 'black', label = 'Analytical')
plt.plot( currentTime, topDisplacement, 'o', color = 'black',  markersize = 5,  markerfacecolor='none', markeredgecolor = 'black', label = 'Numerical')
...
plt.plot( currentTime, bottomPressure, 'o', markersize = 5, color = 'black', markeredgecolor = 'black', markerfacecolor='none', label = 'Numerical')
...
### Plotando dados (função loglog) e linhas de grade (função grid)
#plt.grid( True, which='both', axis='both', linestyle = '-', color = '#B5B5B5' )
#plt.plot( currentTime, totalStress, '-', linewidth = 1.0, color = 'black', label = 'Total Stress')
#plt.plot( currentTime, bottomPressure, '-', linewidth = 1.0, color = 'red', label = 'Pressure')
#plt.plot( currentTime, bottomStress, '-', linewidth = 1.0, color = 'blue', label = 'Effetive Stress')
#
### Mudando a posição e tamanho da área de plotagem
##box = axis.get_position()
##axis.set_position([box.x0-0.03, box.y0+0.03, box.width*0.7, box.height])
...
#
### Configurando a legenda e os "labels" dos eixos
#plt.legend(loc = "center right", numpoints = 1, fontsize = 12, frameon=True )  #, title=r"\bf{Total stress}" )
#plt.ylabel( r" Stress/Pressure(kPa)", size = 16)
#plt.xlabel( r" Time(s) ", size = 16) 
